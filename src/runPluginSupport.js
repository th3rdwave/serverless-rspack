...
module.exports = {
  prepareRun() {
    ...
    this.originalRspackOutputPath = this.rspackOutputPath;
  ...
  watchRun() {
    ...
    this.rspackOutputPath = this.originalRspackOutputPath;
    this.rspackConfig.output.path = this.rspackOutputPath;
    process.chdir(this.serverless.config.servicePath);
