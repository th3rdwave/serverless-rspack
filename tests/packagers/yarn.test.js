...
const yarnModule = require('../../src/packagers/yarn');
...
describe('yarn', () => {
  ...
  describe('getPackagerVersion', () => {
    it('should use yarn version 1.22.19', () => {
      ...
      Utils.spawnProcess.mockReturnValue(
        BbPromise.resolve({ stdout: yarnVersion, stderr: '' }),
      );
  ...
  describe('getProdDependencies', () => {
    it('should use yarn list', () => {
      Utils.spawnProcess.mockReturnValue(
        BbPromise.resolve({ stdout: '{}', stderr: '' }),
      );
    ...
    it('should transform yarn trees to npm dependencies', () => {
      ...
      Utils.spawnProcess.mockReturnValue(
        BbPromise.resolve({ stdout: testYarnResult, stderr: '' }),
      );
      return expect(
        yarnModule.getProdDependencies('myPath', 1),
  ...
  describe('rebaseLockfile', () => {
    ...
    it('should rebase file references', () => {
      ...
      expect(yarnModule.rebaseLockfile('../../project', testContent)).toEqual(
        expectedContent,
      );
    });
  });
  ...
  describe('install', () => {
    ...
    it('should use noNonInteractive option', () => {
      ...
      return expect(
        yarnModule.install('myPath', { noNonInteractive: true }, '1.22.19'),
      )
        .resolves.toBeUndefined()
        .then(() => {
          expect(Utils.spawnProcess).toHaveBeenCalledTimes(1);
    ...
    it('should use ignoreScripts option', () => {
      ...
      return expect(
        yarnModule.install('myPath', { ignoreScripts: true }, '1.22.19'),
      )
        .resolves.toBeUndefined()
        .then(() => {
          expect(Utils.spawnProcess).toHaveBeenCalledTimes(1);
    ...
    it('should use noFrozenLockfile option', () => {
      ...
      return expect(
        yarnModule.install('myPath', { noFrozenLockfile: true }, '1.22.19'),
      )
        .resolves.toBeUndefined()
        .then(() => {
          expect(Utils.spawnProcess).toHaveBeenCalledTimes(1);
    ...
    it('should use networkConcurrency option', () => {
      ...
      return expect(
        yarnModule.install('myPath', { networkConcurrency: 1 }, '1.22.19'),
      )
        .resolves.toBeUndefined()
        .then(() => {
          expect(Utils.spawnProcess).toHaveBeenCalledTimes(1);
  ...
  describe('noInstall', () => {
    it('should skip yarn install', () => {
      return expect(
        yarnModule.install('myPath', { noInstall: true }),
      ).resolves.toBeUndefined();
    });
  });
