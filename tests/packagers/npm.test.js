...
const npmModule = require('../../src/packagers/npm');
...
describe('npm', () => {
  ...
  describe('getPackagerVersion', () => {
    it('should use npm version 6.14.17', () => {
      ...
      Utils.spawnProcess.mockReturnValue(
        BbPromise.resolve({ stdout: npmVersion, stderr: '' }),
      );
  ...
  describe('getProdDependencies', () => {
      ...
      it('should use npm ls', () => {
        ...
        return expect(npmModule.getProdDependencies('myPath', 10))
          ...
          .then(() => {
            ...
            expect(fseMock.pathExistsSync).toHaveBeenCalledWith(
              `myPath${sep}package-lock.json`,
            );
            return null;
          });
      });
    ...
    describe('with lock file', () => {
      ...
      it('should lockfile path be customisable', () => {
        ...
        fsMock.readFileSync.mockReturnValue(JSON.stringify(lockData));
        return expect(
          npmModule.getProdDependencies(
            'root-workspace/packages/my-package',
            1,
            {
  ...
  it('should reject if npm returns critical and minor errors', () => {
    const stderr =
      'ENOENT: No such file\nnpm ERR! extraneous: sinon@2.3.8 ./babel-dynamically-entries/node_modules/serverless-rspack/node_modules/sinon\n\n';
    Utils.spawnProcess.mockReturnValue(
      BbPromise.reject(
  ...
  it('should reject if an error happens without any information in stdout', () => {
    Utils.spawnProcess.mockReturnValue(
      BbPromise.reject(
        new Utils.SpawnError('Command execution failed', '', ''),
      ),
    );
    return expect(npmModule.getProdDependencies('myPath', 1))
      .rejects.toThrow('Command execution failed')
  ...
  it('should ignore minor local NPM errors and log them (NPM >= 7)', () => {
    const stderr = _.join(
      [
        ...
        '  "error": {',
        '    "code": "ELSPROBLEMS",',
        '    "summary": "extraneous: sinon@2.3.8 ./babel-dynamically-entries/node_modules/serverless-rspack/node_modules/sinon\nmissing: internalpackage-1@1.0.0, required by internalpackage-2@1.0.0\npeer dep missing: sinon@2.3.8',
        '    "detail": ""',
        '  }',
        '}',
      ],
