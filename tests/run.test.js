...
const baseModule = require('../src/run');
...
describe('run', () => {
  ...
  describe('watch', () => {
    ...
    it('should throw if rspack watch fails', () => {
      const watch = module.watch.bind(module);
      rspackMock.compilerMock.watch = jest.fn().mockImplementation(() => {
    ...
    it('should turn on polling and set the default poll interval', () => {
      ...
      module.options['rspack-use-polling'] = true;
    ...
    it('should turn on polling and set the specified poll interval', () => {
      ...
      const interval = (module.options['rspack-use-polling'] = _.now() % 10000);
